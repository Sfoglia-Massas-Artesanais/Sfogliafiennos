...
async function carregarPratos() {
  ...
  try {
    const res = await fetch(
      "https://server-sfoglia.onrender.com/pratos?search=refrigerante"
    );
    ...
    pratos.forEach((prato) => {
      ...
      div.innerHTML = `
        ...
        <h4 class="preco">R$ ${prato.preco.toFixed(
          2
        )} <span style="font-size: 8px; color: #4a4646ff; font-weight: 400;">(${
        prato.categoria
      })</span></h4>
